...
- 定投结束后，当资产偏离目标权重的20%时触发再平衡
  例如：40%的纳指，阈值=40%×20%=8%，触发范围32%-48%
       20%的资产，阈值=20%×20%=4%，触发范围16%-24%
"""
...
class ETFBacktest40Nasdaq:
    """ETF投资组合回测类 - 40%纳指 + 相对阈值再平衡"""
    ...
    def generate_report(self):
        ...
        # 保存详细数据到CSV
        output_file = 'backtest_40_nasdaq_result.csv'
...
def main():
    ...
    print("\n" + "="*60)
    print("ETF投资组合回测系统")
    print("40%纳指配置 + 相对阈值触发再平衡")
    print("="*60 + "\n")
    
    # 创建回测实例
    backtest = ETFBacktest40Nasdaq(
